...
function ModalTarea({openModal, setOpenModal}) {

  return (
    <Transition.Root show={ openModal } as={Fragment}>
            <Dialog as="div" className="fixed z-50 inset-0 overflow-y-auto" onClose={() => setOpenModal(false) }>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                ...
                                <span className="sr-only">Cerrar</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="#FF0000">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-left sm:mt-0 sm:ml-4 sm:text-left w-full font-mont">
                                    <Dialog.Title as="h1" className="text-2xl uppercase font-mont text-center leading-6 font-bold text-gray-900">
                                        Nueva Tarea
                                    </Dialog.Title>
